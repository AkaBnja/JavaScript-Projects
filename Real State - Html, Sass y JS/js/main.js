...
function scrollHeader() {
    ...
    // Cuando haya un movimiento de scroll vertical mayor o igual a 50, agregar "scroll-header" en el tag de header
...
// Previosly selected topic (is usar selected)
...
themeButton.addEventListener("click", ()=> {
    // Add or Remover the dark /icon theme
